...
const bigstring = (__range__(0, 2*1024*1024, true).map((i) => "a")).join("");
const mediumstring = (__range__(0, 1024*1024, true).map((j) => "a")).join("");

describe("UpdateCompressor", function() {
	beforeEach(function() {
		this.UpdateCompressor = SandboxedModule.require(modulePath, { requires: {
	...
	describe("convertToSingleOpUpdates", function() {
		it("should split grouped updates into individual updates", function() {
			return expect(this.UpdateCompressor.convertToSingleOpUpdates([{
				op:   [ (this.op1 = { p: 0, i: "Foo" }), (this.op2 = { p: 6, i: "bar"}) ],
			...
			.to.deep.equal([{
				...
				op: this.op3,
				meta: { start_ts: this.ts2, end_ts: this.ts2, user_id: this.other_user_id },
				v: 43
			}]);
	});
		...
		return it("should ignore comment ops", function() {
			return expect(this.UpdateCompressor.convertToSingleOpUpdates([{
				op:   [ (this.op1 = { p: 0, i: "Foo" }), (this.op2 = { p: 9, c: "baz"}), (this.op3 = { p: 6, i: "bar"}) ],
				meta: { ts: this.ts1, user_id: this.user_id },
				v: 42
			}]))
			.to.deep.equal([{
	...
	describe("compress", function() {
		describe("insert - insert", function() {
			it("should append one insert to the other", function() {
				...
				.to.deep.equal([{
					op: { p: 3, i: "foobar" },
					meta: { start_ts: this.ts1, end_ts: this.ts2, user_id: this.user_id
				},
					v: 43
				}]);
		});
			...
			it("should not append separated inserts", function() {
				...
				.to.deep.equal([{
					...
					op: { p: 9, i: "bar" },
					meta: { start_ts: this.ts2, end_ts: this.ts2, user_id: this.user_id
				},
					v: 43
				}]);
		});
		...
		describe("noop - insert", () => it("should leave them untouched", function() {
            return expect(this.UpdateCompressor.compressUpdates([{
                op: this.UpdateCompressor.NOOP,
                meta: { ts: this.ts1, user_id: this.user_id
            },
		...
		return describe("noop - delete", () => it("should leave them untouched", function() {
            return expect(this.UpdateCompressor.compressUpdates([{
                op: this.UpdateCompressor.NOOP,
                meta: { ts: this.ts1, user_id: this.user_id
            },
	...
	return describe("compressRawUpdates", () => describe("merging in-place with an array op", () => it("should not change the existing last updates", function() {
